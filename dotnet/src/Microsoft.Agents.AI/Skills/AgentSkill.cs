...
public abstract class AgentSkill
{
    ...
    /// <summary>
    /// Gets the skill body content (instructions).
    /// </summary>
    ...
    /// <summary>
    /// Gets the arbitrary key-value metadata for this skill.
    /// </summary>
    public IDictionary<string, string> Metadata { get; } = new Dictionary<string, string>();

    /// <summary>
    /// Gets the resources associated with this skill.
    /// </summary>
    public abstract IReadOnlyList<AgentSkillResource> Resources { get; }

    /// <summary>
    /// Gets the scripts associated with this skill.
    /// </summary>
