...
/// Code-defined scripts (<see cref="AgentCodeSkillScript"/>) are always executed in-process and do not use this delegate.
/// </remarks>
...
public delegate Task<object?> FileSkillScriptExecutor(
    AgentSkill skill,
