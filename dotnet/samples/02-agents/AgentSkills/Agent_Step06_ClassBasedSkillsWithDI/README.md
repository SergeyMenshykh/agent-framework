...
- Defining a skill as a reusable class that extends `AgentClassSkill`
...
2. `UnitConverterSkill` extends `AgentClassSkill` and declares its resources and scripts using `AgentInlineSkillResource` and `AgentInlineSkillScript`
...
|--------|-----------|------------|
| [Step04](../Agent_Step04_ClassBasedSkills/) | Class-based (`AgentClassSkill`) | No — static resources |
| [Step06](../Agent_Step06_CodeDefinedSkillsWithDI/) | Code-defined (`AgentInlineSkill`) | Yes — inline delegates |
| **Step07 (this)** | **Class-based (`AgentClassSkill`)** | **Yes — class delegates** |
