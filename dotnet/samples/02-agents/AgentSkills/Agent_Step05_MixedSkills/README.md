...
- Using `AddFileSource`, `AddCodeSkills`, and `AddClassSkills` on the builder
- The `CompositeAgentSkillsSource` aggregating skills from all sources
...
Defined as `AgentCodeSkill` in `Program.cs`. Converts gallons↔liters.
