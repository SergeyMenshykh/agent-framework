...
2. `UnitConverterSkill` extends `AgentClassSkill` and declares its resources and scripts using `AgentCodeSkillResource` and `AgentCodeSkillScript`
...
| [Step06](../Agent_Step06_CodeDefinedSkillsWithDI/) | Code-defined (`AgentCodeSkill`) | Yes — inline delegates |
