...
- Bundling name, description, body, resources, and scripts into a single reusable class
- Using the `AgentSkillsProviderBuilder` with `AddClassSkills`

## Skills Included

### unit-converter (class-based)

A `UnitConverterSkill` class that converts between common units. Defined in `UnitConverterSkill.cs`:
