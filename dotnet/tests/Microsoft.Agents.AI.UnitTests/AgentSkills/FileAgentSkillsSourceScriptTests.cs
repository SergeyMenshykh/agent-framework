...
/// <summary>
/// Unit tests for script discovery and execution in <see cref="FileAgentSkillsSource"/>.
/// </summary>
public sealed class FileAgentSkillsSourceScriptTests : IDisposable
{
    private static readonly string[] s_rubyExtension = new[] { ".rb" };

    private readonly string _testRoot;

    public FileAgentSkillsSourceScriptTests()
    {
    ...
    public async Task GetSkillsAsync_WithExecutor_ScriptsCanExecuteAsync()
    {
        ...
        var source = new FileAgentSkillsSource(
            this._testRoot,
    ...
    public async Task GetSkillsAsync_CustomScriptExtensions_OnlyDiscoversMatchingAsync()
    {
        ...
        var source = new FileAgentSkillsSource(this._testRoot, allowedScriptExtensions: s_rubyExtension);
